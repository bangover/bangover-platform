...
public abstract class EventDrivenEntitySynchronizingEventListener<I, E extends EventDrivenEntity<I, E>,
    V> extends EntitySynchronizingEventListener<I, E, V> {
  ...
  protected void processEntity(E entity, V event) {
    ...
    entity.getPublishedDomainEvents().forEach(descriptor -> {
      GlobalEvents.publisher(descriptor.getBoundedContext(), descriptor.getEventType())
