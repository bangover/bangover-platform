...
public class GlobalEventsConfig {
  ...
  public <E> GlobalEventsConfig withSubscription(BoundedContextId boundedContextId,
      EventType<E> eventType, EventListener<E> eventListener) {
    subscriptions.add(GlobalEvents.subscribeOn(boundedContextId, eventType, eventListener));
    return this;
  }
